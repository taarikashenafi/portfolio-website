...
Command: npx gltfjsx@6.5.3 911.gltf 
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/911.gltf')
  return (
    <group {...props} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]} scale={0.812}>
        <group rotation={[Math.PI / 2, 0, 0]}>
          ...
          <mesh geometry={nodes.Object_113.geometry} material={materials.paint} />
