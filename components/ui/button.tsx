...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-2xl text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-gradient-le-mans text-black border border-black/10 hover:saturate-150',
        destructive:
          'bg-destructive text-destructive-foreground hover:bg-destructive/90',
        outline:
          'border border-input bg-background hover:bg-accent hover:gradient-text-le-mans',
        secondary:
          'bg-gradient-le-mans text-black border border-black/10 hover:saturate-150',
        ghost: 'hover:gradient-text-le-mans',
        link: 'gradient-text-le-mans underline-offset-4 hover:underline',
      },
      size: {
